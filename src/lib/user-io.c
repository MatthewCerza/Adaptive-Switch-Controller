...
double customAnalogRead(int pin){ //A custom analog read program written by Matthew
	ADMUX &= 0xF0; //Clear previously read channel
  	ADMUX |= pin; //Define new ADC Channel to read (which analog pin: 0–5 on ATMega328p
